...
def format_result(
    result: MKResult | PolarizedMKResult | AsymptoticMKResult | AlphaTGResult | DFEResult | ImputedMKResult,
...
def _format_tsv(result: MKResult | PolarizedMKResult | AsymptoticMKResult | AlphaTGResult | DFEResult | ImputedMKResult) -> str:
